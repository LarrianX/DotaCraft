...
public class RuneSpeedEffect extends CustomEffect {
    ...
    public RuneSpeedEffect() {
        ...
        addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, "DDFA971E-9C93-451E-B015-2CCB3A3A4252", 0.5F, EntityAttributeModifier.Operation.MULTIPLY_TOTAL);
    }
